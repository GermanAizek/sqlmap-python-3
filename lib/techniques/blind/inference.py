                ...
                while len(charTbl) > 1:
                    ...
                    if result:
                        ...
                        if not isinstance(charTbl, xrange):
                            ...
                            charTbl = list(range(charTbl[position], charTbl[-1] + 1))
                    else:
                        maxValue = posValue
                        ...
                        if not isinstance(charTbl, xrange):
                            ...
                            charTbl = list(range(charTbl[0], charTbl[position]))
                    ...
                    if len(charTbl) == 1:
                        ...
                        # Going beyond the original charset
                            ...
                            if expand and shiftTable:
                                charTbl = list(range(maxChar + 1, (maxChar + 1) << shiftTable.pop()))
                                originalTbl = list(range(charTbl))
                                maxChar = maxValue = charTbl[-1]
                                minChar = minValue = charTbl[0]
                            else:
                                return None
